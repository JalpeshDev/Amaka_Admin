<?php
 ...
 if(!isset($_SESSION["authToken"]) && !isset($_SESSION['userDetails']) || $_SESSION['userDetails']['data']['userRoles'] != 2){
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a href="../logout.php" class="nav-link btn-danger" style="color:white;">
          Logout
        </a>
      </li>
    </ul>
  ...
  <!-- Main Sidebar Container -->
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #0D0D0D;">
    <!-- Brand Logo -->
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="serviceType/list.php" class="nav-link">              
              <p>
              Service
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="vendorService/list.php" class="nav-link">              
              <p>
              Vendor Service
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="voucher/list.php" class="nav-link">              
              <p>
              Voucher
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="album/list.php" class="nav-link">              
              <p>
              Album
              </p>
            </a>
